...
if __name__ == '__main__':
    ...
    sample_images(generador, img_shape, etiqueta=2, smp_rows=10, smp_cols=10, save_img=True, fig_size=(10, 10)) # Genera conjunto de imagenes
    # sample_single_image(generador, img_shape, label=7, etiqueta=1) # Genera imagen individual
