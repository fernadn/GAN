...
def sample_images(generator, img_shape, latent_dim, etiqueta=1, smp_rows=10, smp_cols=10, save_img=True, fig_size=(10, 10)):
...
def sample_single_image(generator, img_shape, latent_dim, label=1, etiqueta=1, fig_size=(2, 2)):
...
if __name__ == '__main__':
    ...
    latent_dim_m = 110 # Espacio latente de acuerdo a cantidad de imagenes a generar durante entrenamiento
    ...
    sample_images(generador, img_shape_m, latent_dim_m, etiqueta=1, smp_rows=10, smp_cols=10, save_img=True, fig_size=(10, 10)) # Genera conjunto de imagenes
    # sample_single_image(generador, img_shape_m, latent_dim_m, label=5, etiqueta=1) # Genera imagen individual
